    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('planner', 'Planner'), ('supervisor', 'Supervisor'), ('technician', 'Technician')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('issue_option', models.CharField(choices=[('issue', 'Issue'), ('delay', 'Delay')], max_length=10)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('job_order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tasks', to='api.joborder')),
                ('operation', models.ManyToManyField(blank=True, related_name='tasks', to='api.operation')),
            ],
        ),
    ]
